...
description: >-
  ...
  Interactions / Design Engineering / Open Source titles in fixed top and bottom bars). Use when editing section
...
- [ ] Smoke-test scroll **down** and **up** across at least Experiences ↔ Workshop ↔ Open Source
