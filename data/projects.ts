...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: 'Loop Health — AI Assistant (Concept)',
    video: '/assets/video/Loop AI Assistant (LinkedIn Export).mp4',
    description:
      'Self-initiated AI assistant for everyday health questions on Loop — my first backend + AI build (xAI on Vercel), wired into the app to test the idea.',
    ...
    role: 'Staff Product Designer & Technologist',
    context:
      'A self-initiated experiment that grew out of the Dependent Invite flow. AI consults weren’t on Loop’s roadmap, so I built the whole thing myself — design, backend, and app integration — to find out if it could work.',
    process: [
      'Wrote the backend and integrated xAI (Grok) — my first backend + AI project',
      'Tested locally, deployed to Vercel, then wired it into the Loop app',
      'Grounded answers in Loop’s real doctor list and a protocol doc from the backend team',
      'Designed conversation flows, loading, sourcing, and escalation states in SwiftUI',
    ],
    tools: ['SwiftUI', 'xAI (Grok)', 'Vercel', 'Figma'],
    heroCaption: {
      outcomeParts: [
        { text: 'This was my ' },
        { text: 'first backend + AI project', bold: true },
        { text: ' — I wrote the service, integrated ' },
        { text: 'xAI', bold: true },
        { text: ', deployed it to ' },
        { text: 'Vercel', bold: true },
        {
          text: ', and wired it into the Loop app, grounded in the real doctor list. AI consults weren’t on Loop’s roadmap, so I built it as a ',
        },
        { text: 'self-initiated experiment', bold: true },
        { text: ' — shelved, but proof I can take an idea from design through backend to a working demo.' },
      ],
    },
  },
  {
