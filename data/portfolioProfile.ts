...
export const PORTFOLIO_ABOUT = {
  ...
  paragraphs: [
    'Previously he led product and UX design at ETMoney, HDFC Bank, and Paytm across fintech, banking, and consumer apps. As a Rive and Play ambassador in India, he shares interaction design craft through workshops and prototypes built with SwiftUI, Rive, and modern motion tools.',
  ],
  contact:
